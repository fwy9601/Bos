...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<div region="center" style="overflow: auto; padding: 5px;"
		border="false">
		<form id="noticebillForm" action="noticebilAction_add.action" method="post">
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
					...
					<td><input type="text" class="easyui-validatebox"
						name="telephone" required="true" /> <script
								...
								$("input[name=telephone]")
										.blur(
												function() {
													...
													//发送ajax请求,请求action来远程调用crm服务，获取客户信息，用于页面回显
													$
															.post(
																	'noticebiAction_findCustomerByTelephone.action',
																	{
																		'telephone' : telephone
																	},
																	function() {
																		if (data != null) {
																			...
																			$(
																					...
																					.val(
																							customerName);
																			$(
																					"input[name=delegater]")
																					.val(
																							customerName);
																			$(
																					"input[name=pickaddress]")
																					.val(
																							address);
																		} else {
																			//没有查询到客户信息，不能进行回显
