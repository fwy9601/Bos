				...
				if(v1==v2){
					$.post("userAction_editPassword.action",{"password":v1},function(data){
						if(data == '1'){
							...
							//两次输入不一致，弹出提示框
		                    $.messager.alert("提示信息","密码修改失败","waring");
						}
					});
				}else{
					//两次输入不一致，弹出提示框
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form id="editPasswordForm">
	                <table cellpadding=3>
	                    <tr>
	                        <td>新密码：</td>
	                        <td><input required="required" data-options="validType:'length[6,15]'"  id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input required="required" data-options="validType:'length[6,15]'"  id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                </table>
                </form>
            </div>
